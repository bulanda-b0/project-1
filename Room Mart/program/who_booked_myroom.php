...
<?php 
    ...
    $select = "SELECT p.property_type, p.price, p.p_location, p.post_date, p.p_description, p.      property_image, u.firstname, u.middlename, u.lastname, u.email, u.mobileno, u.profile_img FROM signup_form as u
    INNER JOIN booked_room as b ON u.user_id = b.user_id 
    INNER JOIN listproperty_form as p ON p.property_id = b.property_id
    
    WHERE b.property_id = '" . $room_id . "' ";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="who_booked_myroom.css">
</head>
<body>

<div class="room-details">
    
        <h3 class="heading-of-details" >Booked Details</h3>
