...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="owner_list_page.css">
...
<div class="profile-sec">
        <div class="user-info-section">
            <div class="profile-pic">
                ...
                ?> 
                <h3 class="user-id-display" >USER ID: <?php echo $owner_id ?> </h3>
            ...
            <div class="display-info">
                ...
                <div class="information-part">
                    ...
                    margin-left: 50px; background-color: aquamarine;
                     " >First Name: <?php echo $_SESSION['owner_firstname'] ?> </h4> </div>

                    <div style="background-color: aquamarine;" > <h4 style="
                        margin-left: 50px; background-color: aquamarine;
                         "  >Address: <?php echo $_SESSION['owner_addr'] ?> </h4> </div>

                    <div style="background-color: aquamarine;"> <h4 style="
                        margin-left: 50px; background-color: aquamarine;
                         "  >Middle Name: <?php echo $_SESSION['owner_middlename'] ?> </h4> </div>

                    <div style="background-color: aquamarine;"> <h4 style="
                        margin-left: 50px; background-color: aquamarine;
                         "  >Email: <?php echo $_SESSION['owner_email'] ?> </h4> </div>

                    <div style="background-color: aquamarine;"> <h4 style="
                        margin-left: 50px; background-color: aquamarine;
                         "  >Last Name: <?php echo $_SESSION['owner_lastname'] ?> </address></h4> </div>

                    <div style="background-color: aquamarine;"> <h4 style="
                        margin-left: 50px; background-color: aquamarine;
                         "  >Phone No: <?php echo $_SESSION['owner_mobileno'] ?> </h4> </div>
        ...
        <div class="property-management-section">
            ...
            <div class="booked-and-posted-list">
                <h3 class="booked-title" >Posted Rooms</h3> 
                <h3 class="posted-title" >Your Bookings</h3>
            </div>
            ...
            <div class="booked-property-list">
                ...
                <div class="posted-rooms-details">
                 <?php
                         ...
                         $query1 = " SELECT * from listproperty_form where user_id = '" . $owner_id . "' order by property_id desc ";
                ...
                <div class="booked-rooms-details">
                    ...
                    <?php
                         ...
                         $select = "SELECT p.property_type, p.price, p.p_location, p.property_image, p.property_id, b.booked_date FROM listproperty_form AS p INNER JOIN booked_room AS b ON p.property_id = b.property_id WHERE b.user_id = '".$owner_id."' order by booked_id desc  ";
